...
class AppColors {
  ...
  static const Color white25 = Color(0xFFC8C8C8);
  static const Color white10 = Color(0x30C8C8C8);
  static const Color blue = Color(0xFF17ACFF);
  ...
  static const Color red400 = Color(0xFFED1B24);

  static const Color white50Alpha060 = Color(0x99FFFFFF);

  static const Color blue50Alpha060 = Color(0x99EEF0F2);

  static const Color black900Alpha020 = Color(0x33000000);  //transparent
  ...
  //shimmer colors
  static const Color shimmerBaseColor = blue800;
  static const Color shimmerHighlightColor = blue700;
}
